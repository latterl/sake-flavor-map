...
全国の日本酒 1,354 銘柄を「味の傾向」で 2 次元マップに配置し、**選んだ 1 本に味が近い銘柄を探せる**単一 HTML のアプリです。飲んだ酒の記録、★評価とメモ、蔵元公式サイト由来の商品リストと価格も入っています。
...
| **飲んだ酒を記録** | 飲んだ銘柄を登録し、★お気に入りを付けると「好みの中心」に近い**まだ飲んでいない**銘柄を探せます |
| **未踏度で探す** | 飲んだ酒からの距離を濃淡で表示し、「未体験ゾーン」とその代表銘柄を提案します |
| **メモを残す** | 銘柄ごとに★1〜5 の評価と自由記述メモ。ブラウザに自動保存され、ホバー時にも表示されます |
...
- [sake_dataset](https://github.com/yoichi1484/sake_dataset)（MIT）— 公開スペック値
